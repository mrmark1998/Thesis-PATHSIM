...
endp=randompoint(MAP);
xTarget=endp(1);%X Coordinate of the Target
yTarget=endp(2);%Y Coordinate of the Target


startp=randompoint(MAP);
xStart=startp(1);%Starting Position
yStart=startp(2);%Starting Position
